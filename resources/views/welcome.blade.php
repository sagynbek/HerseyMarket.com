        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="text-right">{{ $post['price'] }} &#8378;</p>
                                    
                                    <p> 
            
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="{{ route('product',['id'=>$post->id]) }}" class="btn btn-primary" role="button">Info</a>
                                        </div>
                                        <div class="col-sm-9"> 
                ...
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="thumbnail">
                        <a href="{{route('signin')}}">
                        <img style="height: 200px" src="{{ route('account.image', ['filename' => 'see more.png']) }}" alt="{{$post->pr_name}}" class="img-responsive">
                        </a>
                    </div>
                </div>
            </div>
